...
IUSE="doc fax +hpcups hpijs kde libnotify libressl -libusb0 minimal parport policykit qt5 scanner +snmp static-ppds X zeroconf"
...
COMMON_DEPEND="
	...
	!minimal? (
		...
		snmp? (
			...
			zeroconf? ( $(python_gen_cond_dep 'net-dns/avahi[dbus,${PYTHON_MULTI_USEDEP}]') )
		)
	)
"
BDEPEND="
...
src_prepare() {
	...
	! use zeroconf && eapply "${FILESDIR}/${PVR}-remove_avahi_revert_to_mdns.patch"
